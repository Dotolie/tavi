...
#define MSG_TS_PID0_TYPE				2
#define MSG_TS_PID1_TYPE				3
...
public:
	...
	int M2T_PMTCallback (RMuint16 wPID, RMuint16 wType);
	void M2T_PMSCallback (RMuint16 wPMSPID, RMuint16 wPID, RMuint16 wType);
	RMuint16 M2T_PATCallback (RMuint16 wPID, RMuint16 wProgramNumber);
	void M2TDemuxCallback (RMuint8 *pData, RMuint32 Length, RMuint16 PID, RMuint8 Flags, RMuint64 offset);
